...
{	
	...
	if(!strcasecmp(res,"open beep"))
	{
		...
		PWM_BEEP_flag = 1; 
		OLed_Fill(0);
		Oled_print(10,3,"BEEP is Opened");
	...
	if(!strcasecmp(res,"open LED1"))
	{
		...
		i = 0;
		OLed_Fill(0);
		Oled_print(10,3,"LED1 is Openned");
		memset(res,0,sizeof(res));
	}
	if(!strcasecmp(res,"close beep"))
	{
		...
		PWM_BEEP_flag = 0;
		OLed_Fill(0);
		Oled_print(10,3,"BEEP is Closed");
		memset(res,0,sizeof(res));
	}
	if(!strcasecmp(res,"close LED1"))
	{
		...
		i = 0;
		OLed_Fill(0);
		Oled_print(10,3,"LED1 is Closed");
		memset(res,0,sizeof(res));
	}
...
//		LED_TurnOn(LED2);
		i = 0;
		OLed_Fill(0);
		Oled_print(10,3,"LED2 is Openned");
		memset(res,0,sizeof(res));
		PWM_LED2_flag = 1;
	}
	if(!strcasecmp(res,"close LED2"))
	{
		...
		LED_TurnOff(LED2);
		OLed_Fill(0);
		Oled_print(10,3,"LED2 is Closed");
		memset(res,0,sizeof(res));	
	}
	if(!strcasecmp(res,"open fan"))
	{
		...
		memset(res,0,sizeof(res));
		OLed_Fill(0);
		Oled_print(10,3,"FAN is Openned");
	}
	...
	if(!strcasecmp(res,"middle fan"))
	{
		...
		memset(res,0,sizeof(res));
		OLed_Fill(0);
		Oled_print(10,3,"Middle FAN Speed");
	}
	if(!strcasecmp(res,"fast fan"))
	{
		...
		memset(res,0,sizeof(res));
		OLed_Fill(0);
		Oled_print(10,3,"High FAN Speed");
	}
