...
""));
        ...
        pushButton_4->setGeometry(QRect(397, 400, 101, 51));
...
"}"));
        ...
        lineEdit_2->setGeometry(QRect(247, 318, 291, 61));
        lineEdit_2->setClearButtonEnabled(true);
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(737, 0, 28, 21));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(307, 60, 211, 31));
        label_2->setStyleSheet(QLatin1String("font-size: 20px ;\n"
""));
        pushButton_5 = new QPushButton(centralwidget);
        pushButton_5->setObjectName(QStringLiteral("pushButton_5"));
        pushButton_5->setGeometry(QRect(327, 463, 111, 21));
        QFont font;
        font.setFamily(QStringLiteral("Microsoft YaHei"));
        pushButton_5->setFont(font);
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(274, 400, 101, 51));
        pushButton->setStyleSheet(QStringLiteral(""));
        lineEdit = new QLineEdit(centralwidget);
        lineEdit->setObjectName(QStringLiteral("lineEdit"));
        lineEdit->setGeometry(QRect(247, 250, 291, 61));
        lineEdit->setEchoMode(QLineEdit::PasswordEchoOnEdit);
        lineEdit->setClearButtonEnabled(true);
        label = new QLabel(centralwidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(337, 110, 100, 100));
        label->setMinimumSize(QSize(100, 100));
        label->setMaximumSize(QSize(100, 100));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(770, 0, 28, 21));
